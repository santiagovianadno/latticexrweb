...
export function GitHubLink({ variant = "header" }: GitHubLinkProps) {
  ...
  const styles = {
    header:
      "btn-lit rounded-sm px-3 py-1.5 text-[10px] font-semibold uppercase tracking-wider",
    hero: "btn-lit rounded-sm px-5 py-2.5 text-xs font-semibold uppercase tracking-widest backdrop-blur-sm",
    footer:
      "btn-lit rounded-sm px-4 py-2 text-xs font-semibold uppercase tracking-wider",
  } as const;
